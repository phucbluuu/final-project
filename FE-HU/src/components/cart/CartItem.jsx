...
const CartItem = ({
  item: { id, name, type, banner, color, shadow, price, cartQuantity },
}) => {
    ...
    <>
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          <div
            className={`bg-gradient-to-b ${color} relative rounded p-3 hover:scale-105 transition-all duration-75 ease-in-out grid items-center`}
          >
            <img
              src={banner}
          ...
          <div className="grid items-center gap-4">
            <div className="grid items-center leading-none">
              ...
              <p className="text-sm text-slate-800 lg:text-xs">{type}</p>
            </div>
